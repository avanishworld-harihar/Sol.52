...
export function ProjectHubTabBar({
  ...
  return (
    ...
    >
      <div className="flex w-full min-w-0 gap-0.5 overflow-x-auto rounded-xl border border-slate-200/80 bg-white/90 p-1 shadow-sm backdrop-blur-md [-ms-overflow-style:none] [scrollbar-width:none] dark:border-white/10 dark:bg-[#0c1017]/90 [&::-webkit-scrollbar]:hidden">
        {TAB_CONFIG.map((tab) => {
          ...
          return (
            <button
              ...
              className={cn(
                "relative flex min-h-[2rem] min-w-[4.25rem] shrink-0 items-center justify-center gap-1 rounded-lg px-2.5 py-1.5 text-[11px] font-semibold transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 focus-visible:ring-offset-1 dark:focus-visible:ring-slate-500 sm:min-w-[5rem] sm:px-3 sm:text-[12px]",
                isActive
