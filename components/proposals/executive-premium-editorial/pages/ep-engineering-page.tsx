...
export function EpEngineeringPage({ data }: Props) {
  ...
  return (
    <>
      ...
      {/* Own sheet so heading never orphans from the phase cards in print */}
      <EpLuxuryPage className="ep-gl-engineering-page ep-gl-engineering-page--install">
        <div className="ep-gl-section-tag">{copy.engineering.installTag}</div>
        <h1 className="ep-gl-h1">{copy.engineering.installTitle}</h1>
        <p className="ep-gl-lead">{copy.engineering.installLead}</p>
