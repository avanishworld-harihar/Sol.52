...
export const LUMINA_HERO_PHOTO = "/assets/proposals/lumina-cover-terrace-focus.jpg";
export const LUMINA_HERO_ALT =
  "Luxury Indian rooftop at evening: elevated solar plant with family and friends on the sofa underneath, one friend playing guitar";
