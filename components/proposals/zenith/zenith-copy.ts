    ...
    closing: {
      ...
      steps: hi
        ? [
            ...
            { title: "डिज़ाइन", desc: "SLD + सब्सिडी फाइलिंग" },
            { title: "गो-लाइव", desc: "इंस्टॉल · टेस्ट · हैंडओवर" },
          ]
        : [
            { title: "Survey", desc: "Roof & load check" },
            { title: "Design", desc: "SLD + subsidy filing" },
            { title: "Go-live", desc: "Install · test · handover" },
          ],
    },
    terms: {
      validityHint: hi
