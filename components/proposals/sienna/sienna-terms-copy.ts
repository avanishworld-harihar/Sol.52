/**
 * Terms copy — same legal content as Golden, kept local so Sienna
...
import type { SiennaLang } from "./sienna-copy";

export type SiennaTermsModel = {
...
export function buildSiennaTermsModel(
  data: ProposalData,
  lang: SiennaLang = "en"
): SiennaTermsModel {
  const hi = lang === "hi";
