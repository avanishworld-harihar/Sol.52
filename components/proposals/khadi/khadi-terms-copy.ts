/**
 * Terms copy — same legal content as Golden, kept local so Khadi
...
import type { KhadiLang } from "./khadi-copy";

export type KhadiTermsModel = {
...
export function buildKhadiTermsModel(
  data: ProposalData,
  lang: KhadiLang = "en"
): KhadiTermsModel {
  const hi = lang === "hi";
