...
export function BlockROIDashboard({ ctx }: Props) {
  ...
  return (
    <div className="mx-auto max-w-6xl px-5 py-16 sm:px-8 md:px-12 md:py-24">
      ...
      <div className="commercial-roi-kpi-grid mb-12 grid grid-cols-2 gap-4 lg:grid-cols-4">
        {kpis.map((kpi, i) => (
          <KpiCard
            key={kpi.label}
            icon={kpi.icon}
      ...
      <div className="grid gap-6 lg:grid-cols-5">
        ...
        <SectionReveal className="commercial-print-keep-together lg:col-span-3" delay={0.05}>
