...
export function resolveResidentialThemeKey(input: {
  ...
  if (input.galleryKey === "brutalism") return "golden";
  ...
  if (input.galleryKey === "voltaic") return "golden";
  ...
  if (preset === "residential_brutalism") return "golden";
  ...
  if (preset === "residential_voltaic") return "golden";
